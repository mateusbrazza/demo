...
class TestStepFunctions:
    ...
    def test_integration_full_flow(self, setup_test_env, setup_s3_test_files):
        ...
        beforeyesterday = (datetime.strptime(execution_date, "%Y-%m-%d") - timedelta(days=2)).strftime("%Y-%m-%d")
        ...
        setup_s3_test_files([
            ...
            {
                'path': 'daily_files/file_3.json',
                'key': f"consents/{beforeyesterday}/file_3.json"
            },
            {
